...
3. Lancer le container :
   docker compose up -d
4. Frontend accessible sur http://localhost:8080
5. Healthcheck disponible, container non-root, build reproductible.
6. Pas de données persistantes dans ce container.