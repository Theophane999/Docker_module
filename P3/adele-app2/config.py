...
# basé sur le répertoire du fichier config.py
...
class Config(object):
    ...
    # CORRECTION : Utilisation du chemin absolu /app/db/adele.sqlite pour la stabilité Docker
    SQLALCHEMY_DATABASE_URI = 'sqlite:////app/db/adele.sqlite'
...
class TestConfig(Config):
    ...
    # CORRECTION : Utilisation du chemin absolu pour les tests également si besoin
    SQLALCHEMY_DATABASE_URI = 'sqlite:////app/tests/data/adele.test.sqlite'
